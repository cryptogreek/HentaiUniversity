var character = {index: "nikki", fName: "Nikki", lName: "Thrasher", trust: 0, encountered: false, textEvent: "", met: false, color: "#89a3a4", author: "Cryptogreek", artist: "Enoshima Iki"};
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	{index: "nikki1", name: "You spot someone walking down the hall", location: 'EastHallway', time: "Evening", itemReq: "", trustMin: 0, trustMax: 0, type: "tab", top: 0, left: 0, day: "both", altName: "", altImage: "",},
