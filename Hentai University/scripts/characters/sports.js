...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	{index: "sports1", name: "The volleyball team is practicing this afternoon. One of the girls catches your eye.", location: 'gym', time: "Evening", itemReq: "", trustMin: 0, trustMax: 0, type: "tab", top: 0, left: 0, day: "odd",},
	{index: "sports2", name: "sports is working on some homework in the classroom.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 1, trustMax: 10, type: "tab", top: 0, left: 0, day: "even",},
	{index: "sports3", name: "sports is studying late again. She seems twitchy as you approach.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 20, trustMax: 22, type: "tab", top: 0, left: 0, day: "even",},
	...
	{index: "sports5", name: "sports is fidgiting in the classroom, long after everyone else has called it quits for the day.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 105, trustMax: 110, type: "tab", top: 0, left: 0, day: "even",},
	...
	{index: "sports7", name: "sports is waiting patiently for you.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 125, trustMax: 125, type: "tab", top: 0, left: 0, day: "even",},
	{index: "sports8", name: "sports is working on homework again, though now she looks much happier with it than when you first saw her.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 131, trustMax: 140, type: "tab", top: 0, left: 0, day: "even",},
	{index: "sportsfinalclass", name: "sports is hanging around the classroom, she glows when she sees you.", location: 'classroomB', time: "Evening", itemReq: "", trustMin: 150, trustMax: 200, type: "tab", top: 0, left: 0, day: "even",},
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "sports6a": {//Swimsuit Sex Start (y)
			...
			writeSpeech("swimmer", "", "Oh! playerT playerF, sportsF said she'd be a little late to counselling. She thinks she twisted her ankle at the end of practice and wanted to take a long shower and stretch herself out some to make sure it wasn't anything serious.");
		...
		case "sports7": {//Take her home (y/n)
			...
			writeText("She moves closer to you. The room hasn't emptied out yet, a few students are still chatting and workingthrough an assignment in the corner.");
			...
			writeText("She closes the last distance between you and puts her lips up to your ear, whispering sofly as she leans in.");
			...
			writeFunction("changeLocation(data.player.location)", "As much as you'd like to, you have other things to do tonight. Rain chack?");
			break;
		}
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		...
		case "sports4b": {//Back of the gym
			...
			writeText("There wan't even a hint of hesitation in that outburst.");
			...
			writeText("There's a flash across her face as she says those words. Resignation, followed by embarassment.");
		...
		case "sports4c": {//Back of the gym continued, first fuck - Breaking
			...
			writeBig("images/sports/4a1.jpg", "Art by Himitsu Kessha Vanitas");
			writeText("Your first thrust takes her by surprise, and you feel her cum as you slide yourself all the way in, her tight cunt already dripping wet and slick making it easy to bottom out in her. As her first orgasm subsides, you feel her get limb in your arms.");
			...
			writeSpeech("player", "", "I'm your Master. And you should adress me as such when we're alone. Keep behaving like normal when we're not together, otherwise we may get caught. And if we get caught, I'll never be able to help you <i>relax</i> again.");
		...
		case "sports5b": {//Classroom Blowjob
			...
			writeText("You keep speaking as she gets started, following your instructions to the letter. She never takes her tongue or her hands off of your cock, worshipping it like it was the only thing in the world that mattered to her. She's a very good student.");
		...
		case "sports6c": {//Swimsuit Sex
			...
			writeBig("images/sports/6c2.jpg", "Art by Himitsu Kessha Vanitas");
			writeText("You move faster and faster, and you feel her repond in kind. You can feel her moving as you hold her up, moving her hips back and forth as much as she can while she's held like this. When you squeeze her tit, you feel her cunt clench, bringing you closer and closer to the edge.");
			...
			writeBig("images/sports/6c3.jpg", "Art by Himitsu Kessha Vanitas");
			writeText("As you cum, you squeeze her breast as hard as you can, and pull her back into you. She creams in pleasure and you feel her own orgasm as she twitches and tries desperately to hold herself up.");
			writeBig("images/sports/6c4.jpg", "Art by Himitsu Kessha Vanitas");
			writeSpeech("sports", "", "Aah~. Hah~. Thank you for using me, Master. I hope your fuck toy did a good job today.");
			writeText("You grab her hair and twist her head, planting a quick kiss on the forehead.");
		...
		case "sports7b": {//Take her home
			...
			writeText("She reaches down desperately. Unzipping your pants and ripping your cock out, before rubbing it against her weet pussy. Teasing both of you, and lubing your cock up for entry before slowly lining you up to her entrance and sliding you in.");
			writeBig("images/sports/7b3.jpg", "Art by Himitsu Kessha Vanitas");
			...
			writeText("Seeing her prostrate her infront of you, you know there won't be a problem finding a round two. Or three. Or four, tonight.");
		...
		case "sports7c": {//Take her home
			...
			writeText("Once she's made it to the bed, she puts her head all the way down, facing away from you, back arched, hands in front of her stretched out. Her ass, up in the air, slighly waving as she waits for you to use her.");
			...
			writeText("That's what you were wating for. You quickly line yourself up, running your cock once more along her cunt to wet yourself and make sure you're nicely lubed before placing the head of your cock on her puckered asshole.");
		...
		case "sports8c": {//Cat Outfit
			writeText("As you lie there, your pet rubs your cock against her slit, teasing her entrance before she smootly lowers herself down.");
			writeBig("images/sports/8c1.jpg", "Art by Himitsu Kessha Vanitas");
			writeSpeech("sports", "sportsP.jpg", "Nyaaa!~");
			writeText("She seems to be taking her role as a pet seriously, as she moves, you hear her purr and cry out, mimicing the sounds of a cat... Or, more accurately, mimicing the sounds of cat girl porn.");
			writeBig("images/sports/8c2.jpg", "Art by Himitsu Kessha Vanitas");
